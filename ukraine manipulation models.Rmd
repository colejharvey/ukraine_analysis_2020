...
model.interaction.east.s <- lm(coefs.east  ~ #average.wage + 
                                ...
                                +urban.pct + logpop + logincome + ukr.lang.pct + 
                                  highered 
                                + presidential.x + round.2.x + orangerev + maidan + yanukovych #+ wartime.election
                                + party.margin + #+crisis.year 
                                #+ east.approval.margin 
...
interplot(model.interaction.east.s, var1="orangerev", var2="party.margin")
```

Orange rev has no effect on east party coefficients anywhere

```{r maidan west}
model.interaction.west.maidan <- lm(coefs.west ~ #average.wage + 
                                  logold  
                                + loggov #+ edu.employ + health.employ #gov.employ and the other employs are highly cor.
                                +urban.pct + logpop + logincome + ukr.lang.pct + 
                                  highered 
                                + presidential.x + round.2.x + orangerev + yanukovych + maidan #+ wartime.election
                                + party.margin #+crisis.year 
                                #+ east.approval.margin 
                              +  party.margin*maidan ,
                              data=ukrdata)
...
```{r maidan east}
model.interaction.east.maidan <- lm(coefs.east ~ #average.wage + 
                                  logold  
                                + loggov #+ edu.employ + health.employ #gov.employ and the other employs are highly cor.
                                +urban.pct + logpop + logincome + ukr.lang.pct + 
                                  highered 
                                + presidential.x + orangerev + yanukovych  + maidan #+ wartime.election
                                + party.margin #+crisis.year 
                                #+ east.approval.margin 
                              +  party.margin*maidan ,
                              data=ukrdata)
summary(model.interaction.east.maidan) 
interplot(model.interaction.east.maidan, var1="maidan", var2="party.margin")
